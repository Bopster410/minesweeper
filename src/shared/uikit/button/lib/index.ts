...
import slidersTmpl from './svgTemplates/index.sliders.pug';
...
import lightTmpl from './svgTemplates/darklight/index.light.pug';
import darkTmpl from './svgTemplates/darklight/index.dark.pug';
...
export function getSlidersBtn(parent: Element, props: ButtonProps) {
    props.btnIconFunc = slidersTmpl;
    props.btnText = '';
    return new Button(parent, props);
}
...
export function getDarkLightBtn(parent: Element, props: ButtonProps) {
    props.btnIconFunc = lightTmpl;
    props.btnText = '';
    props.toggle = {
        btnIconFunc: darkTmpl,
        btnText: '',
    };
